...
export default function HomeScreen() {
  ...
  return <Screen><ScrollView contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); load(); }} />}>
    ...
    <View style={styles.quickGrid}>{[
      ["calendar-outline", "Appointment", "/(tabs)/services"], ["notifications-outline", "Reminders", "/(tabs)/reminders"], ["cut-outline", "Services", "/(tabs)/services"], ["gift-outline", "Referral", "/(tabs)/referral"]
